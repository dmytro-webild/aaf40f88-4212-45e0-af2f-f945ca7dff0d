...
export default function LandingPage() {
  ...
  <div id="about" data-section="about">
      ...
      bulletPoints={[
        {
          title: "Integrity",
          description: "We are honest about what you need and what you don't.",
        },
        {
          title: "Reliability",
        ...
        {
          title: "Quality Work",
          description: "Superior materials and expert installation guaranteed.",
        },
      ]}
  ...
  <div id="services" data-section="services">
      ...
      features={[
        {
          title: "Roof Repair",
          description: "Prompt and professional fixes for damaged shingles and minor issues.",
          imageSrc: "http://img.b2bpic.net/free-photo/man-working-roof-with-drill-low-view_23-2148748772.jpg",
        },
        {
          title: "Leak Fixing",
          description: "Expert diagnostic and lasting solutions for troublesome leaks.",
          imageSrc: "http://img.b2bpic.net/free-photo/full-shot-man-working-with-paint_23-2149714286.jpg",
        },
        {
          title: "Full Installation",
          description: "New roof builds executed with precision for maximum longevity.",
  ...
  <div id="gallery" data-section="gallery">
      ...
      products={[
        ...
        },
        {
          ...
          price: "Completed",
          imageSrc: "http://img.b2bpic.net/free-photo/yellow-facade-small-house-camping-de-nolle-vlissingen-netherlands_181624-20422.jpg",
        },
        {
          id: "5",
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/man-holding-hammer-drill-looking-away_23-2148748783.jpg",
          alt: "Client 3",
        },
        {
